...
<section class= "py-5">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <a href="." class="btn btn-primary">Go Dashboard</a>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <span class="for-text">Diisi jika ingin mengubah Password</span>
                    </div>
                </div>
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <span class="for-text">Diisi jika ingin mengubah Foto</span>
                    </div>
                </div>
            </div>
